...
public interface InterfaceClientModel {
	...
	void setholdMsg(InterfaceMessage holdMsg);
	
	InterfaceMessage returnholdMsg();
	
	boolean flagMsg(int messageId, String flag);
	
	boolean setAlias(String origin, String newAlias);
	...
	boolean undoalias(String previousalias);
	
	boolean cr(String destfolder, String searchtype, String searchkey);
	int getcrcounter();
	
	void runtherules();
	void setrules(InterfaceRules onerule);
}